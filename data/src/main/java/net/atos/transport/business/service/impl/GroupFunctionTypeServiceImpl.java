...
public class GroupFunctionTypeServiceImpl implements GroupFunctionTypeService
{
    ...
    public List<GroupFunctionType> findAll()
    {
        ...
        {
            beans.add(groupFunctionTypeServiceMapper
                    .mapGroupFunctionTypeEntityToGroupFunctionType(groupFunctionTypeEntity));
        }
        return beans;
    }
    ...
    {
        GroupFunctionTypeEntity groupFunctionTypeEntity = groupFunctionTypeJpaRepository.findOne(groupFunctionType
                .getGftId());
        ...
        return groupFunctionTypeServiceMapper
                .mapGroupFunctionTypeEntityToGroupFunctionType(groupFunctionTypeEntitySaved);
    }
