...
public class TicketAllocationCodeServiceImpl implements TicketAllocationCodeService
{
    ...
    public List<TicketAllocationCode> findAll()
    {
        ...
        {
            beans.add(ticketAllocationCodeServiceMapper
                    .mapTicketAllocationCodeEntityToTicketAllocationCode(ticketAllocationCodeEntity));
        }
        return beans;
    }
    ...
    {
        TicketAllocationCodeEntity ticketAllocationCodeEntity = ticketAllocationCodeJpaRepository
                .findOne(ticketAllocationCode.getTacId());
