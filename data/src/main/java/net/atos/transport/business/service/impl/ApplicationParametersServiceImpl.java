...
public class ApplicationParametersServiceImpl implements ApplicationParametersService
{
    ...
    public List<ApplicationParameters> findAll()
    {
        ...
        {
            beans.add(applicationParametersServiceMapper
                    .mapApplicationParametersEntityToApplicationParameters(applicationParametersEntity));
        }
        return beans;
    }
    ...
    {
        ApplicationParametersEntity applicationParametersEntity = applicationParametersJpaRepository
                .findOne(applicationParameters.getApplicationParametersId());
    ...
    public void setApplicationParametersJpaRepository(
            ApplicationParametersJpaRepository applicationParametersJpaRepository)
    {
    ...
    public void setApplicationParametersServiceMapper(
            ApplicationParametersServiceMapper applicationParametersServiceMapper)
    {
