...
public class FaresCheckingExclusionServiceImpl implements FaresCheckingExclusionService
{
    ...
    public List<FaresCheckingExclusion> findAll()
    {
        ...
        {
            beans.add(faresCheckingExclusionServiceMapper
                    .mapFaresCheckingExclusionEntityToFaresCheckingExclusion(faresCheckingExclusionEntity));
        }
        return beans;
    }
    ...
    {
        FaresCheckingExclusionEntity faresCheckingExclusionEntity = faresCheckingExclusionJpaRepository
                .findOne(faresCheckingExclusion.getFaresCheckingExclusionId());
    ...
    public void setFaresCheckingExclusionJpaRepository(
            FaresCheckingExclusionJpaRepository faresCheckingExclusionJpaRepository)
    {
    ...
    public void setFaresCheckingExclusionServiceMapper(
            FaresCheckingExclusionServiceMapper faresCheckingExclusionServiceMapper)
    {
        this.faresCheckingExclusionServiceMapper = faresCheckingExclusionServiceMapper;
    }

    @Override
    public FaresCheckingExclusion getFaresExclusionByParams(String sellingLocation, String originLocation,
            String destinationLocation, String route, String product, String ticketStatus)
    {
        FaresCheckingExclusionEntity entity = faresCheckingExclusionJpaRepository.findByParams(sellingLocation,
                originLocation, destinationLocation, route, product, ticketStatus);
