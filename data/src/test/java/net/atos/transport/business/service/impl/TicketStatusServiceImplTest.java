...
public class TicketStatusServiceImplTest {
	...
	public void findById() {
		...
		when(ticketStatusServiceMapper.mapTicketStatusEntityToTicketStatus(ticketStatusEntity)).thenReturn(ticketStatus);
	...
	public void findAll() {
		...
		when(ticketStatusServiceMapper.mapTicketStatusEntityToTicketStatus(ticketStatusEntity1)).thenReturn(ticketStatus1);
		TicketStatus ticketStatus2 = ticketStatusFactoryForTest.newTicketStatus();
		when(ticketStatusServiceMapper.mapTicketStatusEntityToTicketStatus(ticketStatusEntity2)).thenReturn(ticketStatus2);
	...
	public void create() {
		...
		when(ticketStatusServiceMapper.mapTicketStatusEntityToTicketStatus(ticketStatusEntitySaved)).thenReturn(ticketStatusSaved);
