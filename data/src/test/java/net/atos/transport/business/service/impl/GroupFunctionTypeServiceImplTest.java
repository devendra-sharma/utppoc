...
public class GroupFunctionTypeServiceImplTest {
	...
	public void findById() {
		...
		when(groupFunctionTypeServiceMapper.mapGroupFunctionTypeEntityToGroupFunctionType(groupFunctionTypeEntity)).thenReturn(groupFunctionType);
	...
	public void findAll() {
		...
		GroupFunctionTypeEntity groupFunctionTypeEntity1 = groupFunctionTypeEntityFactoryForTest.newGroupFunctionTypeEntity();
		groupFunctionTypeEntitys.add(groupFunctionTypeEntity1);
		GroupFunctionTypeEntity groupFunctionTypeEntity2 = groupFunctionTypeEntityFactoryForTest.newGroupFunctionTypeEntity();
		...
		when(groupFunctionTypeServiceMapper.mapGroupFunctionTypeEntityToGroupFunctionType(groupFunctionTypeEntity1)).thenReturn(groupFunctionType1);
		GroupFunctionType groupFunctionType2 = groupFunctionTypeFactoryForTest.newGroupFunctionType();
		when(groupFunctionTypeServiceMapper.mapGroupFunctionTypeEntityToGroupFunctionType(groupFunctionTypeEntity2)).thenReturn(groupFunctionType2);
	...
	public void create() {
		...
		GroupFunctionTypeEntity groupFunctionTypeEntity = groupFunctionTypeEntityFactoryForTest.newGroupFunctionTypeEntity();
		...
		when(groupFunctionTypeServiceMapper.mapGroupFunctionTypeEntityToGroupFunctionType(groupFunctionTypeEntitySaved)).thenReturn(groupFunctionTypeSaved);
	...
	public void update() {
		...
		GroupFunctionTypeEntity groupFunctionTypeEntitySaved = groupFunctionTypeEntityFactoryForTest.newGroupFunctionTypeEntity();
		...
		// Then
		verify(groupFunctionTypeServiceMapper).mapGroupFunctionTypeToGroupFunctionTypeEntity(groupFunctionType, groupFunctionTypeEntity);
		assertTrue(groupFunctionTypeResult == groupFunctionTypeSaved);
	}
