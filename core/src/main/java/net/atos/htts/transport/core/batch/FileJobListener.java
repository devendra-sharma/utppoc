...
public class FileJobListener extends ItemListenerSupport<String, Exception>
	...
	public void onProcessError(String item, Exception e) {
		...
		if (null != stepExecution.getJobExecution().getExecutionContext()
			...
			errorItem = (List) stepExecution.getJobExecution().getExecutionContext().get("ErrorItem");
			errorItem.add(data);
			stepExecution.getJobExecution().getExecutionContext()
					.put("ErrorItem", errorItem);
		} else {
			...
			data.setMessage(e.getMessage());
			errorItem.add(data);
			stepExecution.getJobExecution().getExecutionContext().put("ErrorItem", errorItem);
